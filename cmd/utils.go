...
import (
	...
	"github.com/versioneer-tech/package-r/v2/storage/bolt"
)
...
func python(fn pythonFunc, cfg pythonConfig) cobraFunc {
	return func(cmd *cobra.Command, args []string) {
		...
		if err != nil {
			...
			log.Println("Warning: package-r.db can't be found. Initialing in " + strings.TrimSuffix(absPath, "package-r.db"))
		}
