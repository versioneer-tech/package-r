...
func init() {
	...
	persistent.StringP("database", "d", "./package-r.db", "database path")
...
var rootCmd = &cobra.Command{
	Use:   "package-r",
	Short: "A stylish web-based content packageR",
	Long: `packageR CLI lets you create the database to use with packageR,
manage your users and all the configurations without acessing the
web interface.

If you've never run packageR, you'll need to have a database for
...
func quickSetup(flags *pflag.FlagSet, d pythonData) {
	...
	defaultBuckets := strings.Split(os.Getenv("BUCKET_DEFAULT"), "|")
	for _, defaultBucket := range defaultBuckets {
		set.Sources[defaultBucket] = map[string]string{}
	}
